...
class CalendarSingleAdapter(
    ...
    class ViewHolder(view: View, private val onAction: (CalendarDate) -> Unit) :
        ...
        fun bind(calendarDate: CalendarDate, isViewByWeek: Boolean) {
            ...
            changeColor(calendarDate, isViewByWeek)
        }
        ...
        private fun changeColor(calendarDate: CalendarDate, isViewByWeek: Boolean) {
            if (isViewByWeek) {
                when {
